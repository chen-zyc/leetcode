- [538. 把二叉搜索树转换为累加树](#538-把二叉搜索树转换为累加树)
  - [官方题解](#官方题解)
    - [方法一：反序中序遍历](#方法一反序中序遍历)
    - [方法二：Morris 遍历](#方法二morris-遍历)
...
由这样的性质我们可以发现，二叉搜索树的**中序遍历是一个单调递增的有序序列**。如果我们反序地中序遍历该二叉搜索树，即可得到一个单调递减的有序序列。
...
2. 如果当前节点的右子节点不为空，找到当前节点右子树的最左节点（该节点为当前节点中序遍历的前驱节点(应该是反向中序遍历的前驱节点)）；
