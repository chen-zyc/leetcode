- [297. 二叉树的序列化与反序列化](#297-二叉树的序列化与反序列化)
  ...
  - [题解](#题解)
    ...
    - [方法二：括号表示编码 + 递归下降解码](#方法二括号表示编码--递归下降解码)
...
![](assets/no_0297_serialize_and_deserialize_binary_tree_1.png)
...
根据这样的定义，我们很好写出序列化的过程，**后序遍历**这颗二叉树即可，那如何反序列化呢？根据定义，我们可以推导出这样的巴科斯范式（BNF）：
